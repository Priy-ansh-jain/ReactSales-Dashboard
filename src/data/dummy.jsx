...
import { MdEmail, MdOutlineSupervisorAccount } from "react-icons/md";
...
export const salesData = {
  ...
  sales: [1500, 2100, 3000, 2600, 4000, 5000, 4200, 6000, 5400, 6800, 7300, 8000],
};
...
export const stocks = [
  { id: 1, name: 'Apple', symbol: 'AAPL', price: 145.09 },
  { id: 2, name: 'Microsoft', symbol: 'MSFT', price: 289.67 },
  { id: 3, name: 'Tesla', symbol: 'TSLA', price: 730.25 },
  { id: 4, name: 'Amazon', symbol: 'AMZN', price: 3300.00 },
  { id: 5, name: 'Alphabet', symbol: 'GOOGL', price: 2800.00 },
  { id: 6, name: 'Meta', symbol: 'META', price: 358.90 },
  { id: 7, name: 'Netflix', symbol: 'NFLX', price: 615.00 },
  { id: 8, name: 'NVIDIA', symbol: 'NVDA', price: 190.50 },
  { id: 9, name: 'Zoom Video', symbol: 'ZM', price: 300.40 },
  { id: 10, name: 'PayPal', symbol: 'PYPL', price: 270.20 },
  { id: 11, name: 'Salesforce', symbol: 'CRM', price: 220.10 },
  { id: 12, name: 'Adobe', symbol: 'ADBE', price: 670.99 },
  { id: 13, name: 'Berkshire Hathaway', symbol: 'BRK.A', price: 410000 },
  { id: 14, name: 'Coca-Cola', symbol: 'KO', price: 55.90 },
  { id: 15, name: 'Walmart', symbol: 'WMT', price: 140.30 },
  { id: 16, name: 'Nike', symbol: 'NKE', price: 160.90 },
  { id: 17, name: 'McDonald\'s', symbol: 'MCD', price: 250.40 },
  { id: 18, name: 'Visa', symbol: 'V', price: 220.70 },
  { id: 19, name: 'MasterCard', symbol: 'MA', price: 380.00 },
  { id: 20, name: 'Starbucks', symbol: 'SBUX', price: 115.00 },
];

export const cryptocurrencies = [
  { id: 1, name: 'Bitcoin', symbol: 'BTC', price: 48000 },
  { id: 2, name: 'Ethereum', symbol: 'ETH', price: 3500 },
  { id: 3, name: 'Cardano', symbol: 'ADA', price: 2.25 },
  { id: 4, name: 'Ripple', symbol: 'XRP', price: 1.20 },
  { id: 5, name: 'Litecoin', symbol: 'LTC', price: 180.50 },
  { id: 6, name: 'Polkadot', symbol: 'DOT', price: 35.60 },
  { id: 7, name: 'Chainlink', symbol: 'LINK', price: 27.80 },
  { id: 8, name: 'Dogecoin', symbol: 'DOGE', price: 0.25 },
  { id: 9, name: 'Stellar', symbol: 'XLM', price: 0.36 },
  { id: 10, name: 'Uniswap', symbol: 'UNI', price: 25.40 },
  { id: 11, name: 'Bitcoin Cash', symbol: 'BCH', price: 620.00 },
  { id: 12, name: 'Terra', symbol: 'LUNA', price: 92.40 },
  { id: 13, name: 'Avalanche', symbol: 'AVAX', price: 60.20 },
  { id: 14, name: 'Solana', symbol: 'SOL', price: 150.10 },
  { id: 15, name: 'VeChain', symbol: 'VET', price: 0.14 },
  { id: 16, name: 'TRON', symbol: 'TRX', price: 0.12 },
  { id: 17, name: 'IOTA', symbol: 'MIOTA', price: 1.80 },
  { id: 18, name: 'Algorand', symbol: 'ALGO', price: 1.20 },
  { id: 19, name: 'Cosmos', symbol: 'ATOM', price: 44.20 },
  { id: 20, name: 'Filecoin', symbol: 'FIL', price: 78.30 },
];
export const initialUsers = [
  { id: 1, name: 'John Doe', email: 'john@example.com', deposit: 500, product: 'Apple', loginTime: '10:30 AM' },
  { id: 2, name: 'Jane Smith', email: 'jane@example.com', deposit: 300, product: 'Microsoft', loginTime: '11:15 AM' },
  { id: 3, name: 'Michael Johnson', email: 'michael@example.com', deposit: 700, product: 'Data Science', loginTime: '09:45 AM' },
  { id: 4, name: 'Alice Brown', email: 'alice@example.com', deposit: 800, product: 'AI/ML', loginTime: '12:00 PM' },
  { id: 5, name: 'Bob Williams', email: 'bob@example.com', deposit: 450, product: 'Blockchain', loginTime: '01:10 PM' },
  { id: 6, name: 'Charlie White', email: 'charlie@example.com', deposit: 200, product: 'Web Development', loginTime: '02:20 PM' },
  { id: 7, name: 'David Green', email: 'david@example.com', deposit: 1000, product: 'Cybersecurity', loginTime: '03:30 PM' },
  { id: 8, name: 'Emma Watson', email: 'emma@example.com', deposit: 900, product: 'AI/ML', loginTime: '04:00 PM' },
  { id: 9, name: 'Frank Thomas', email: 'frank@example.com', deposit: 1200, product: 'Data Science', loginTime: '05:45 PM' },
  { id: 10, name: 'Grace Harris', email: 'grace@example.com', deposit: 650, product: 'Blockchain', loginTime: '06:15 PM' },
  { id: 11, name: 'Henry Lee', email: 'henry@example.com', deposit: 400, product: 'AI/ML', loginTime: '07:20 PM' },
  { id: 12, name: 'Ivy Carter', email: 'ivy@example.com', deposit: 550, product: 'Web Development', loginTime: '08:00 PM' },
  { id: 13, name: 'Jack Clark', email: 'jack@example.com', deposit: 600, product: 'Data Science', loginTime: '08:45 PM' },
  { id: 14, name: 'Katy Taylor', email: 'katy@example.com', deposit: 1100, product: 'Cybersecurity', loginTime: '09:10 PM' },
  { id: 15, name: 'Liam Adams', email: 'liam@example.com', deposit: 850, product: 'Blockchain', loginTime: '10:30 PM' },
  { id: 16, name: 'Mia Wilson', email: 'mia@example.com', deposit: 750, product: 'AI/ML', loginTime: '11:00 PM' },
  { id: 17, name: 'Nathan Scott', email: 'nathan@example.com', deposit: 950, product: 'Web Development', loginTime: '11:30 PM' },
  { id: 18, name: 'Olivia King', email: 'olivia@example.com', deposit: 1250, product: 'Data Science', loginTime: '12:00 AM' },
  { id: 19, name: 'Paul Walker', email: 'paul@example.com', deposit: 1300, product: 'Cybersecurity', loginTime: '12:30 AM' },
  { id: 20, name: 'Quinn Evans', email: 'quinn@example.com', deposit: 1400, product: 'Blockchain', loginTime: '01:00 AM' }
];
